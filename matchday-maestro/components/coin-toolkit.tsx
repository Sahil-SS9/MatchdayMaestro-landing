...
export function CoinToolkit() {
  const coinFeatures = [
    ...
    { icon: Dices, name: "Lucky Dip", cost: "75 coins", color: "#10B981", description: "AI analyzes the match data and suggests the best pick.", useCase: "When you are stuck between two outcomes, let machine learning make the call." },
